...
public class TextBox extends Gui
{
    ...
    public TextBox(int componentId, FontRenderer fontrendererObj, float x, float y, int par5Width, int par6Height)
    {
        this.id = componentId;
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            {
                drawRect(this.xPosition - 1, this.yPosition - 1, this.xPosition + this.width + 1, this.yPosition + this.height + 1, 0x22222222);
                drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, 0xFF222222);
            }
            ...
            } else if (s.length() == 0 && emptyString.length() != 0) {
                this.fontRendererInstance.drawStringWithShadow(emptyString, (float)j1, (float)i1, 0xFF707070);
            }
