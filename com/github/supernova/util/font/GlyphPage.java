...
public class GlyphPage {
    ...
    public float drawChar(char ch, float x, float y) {
        ...
        draw(x, y, pageX, pageY, pageWidth, pageHeight, width, height);

        return width - 8;
    }

    private void draw(float x, float y, float pageX, float pageY, float pageWidth, float pageHeight, float width, float height) {
