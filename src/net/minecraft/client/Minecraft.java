...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public FontRenderer blockyFontObj;
    public FontRenderer curvedFontObj;
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        this.blockyFontObj = new FontRenderer(this.gameSettings, new ResourceLocation("font/blocky.png"), this.renderEngine, false);
        this.curvedFontObj = new FontRenderer(this.gameSettings, new ResourceLocation("font/curved.png"), this.renderEngine, false);
        ...
        this.mcResourceManager.registerReloadListener(this.blockyFontObj);
        this.mcResourceManager.registerReloadListener(this.curvedFontObj);
    ...
    private void setWindowIcon()
    {
        ...
        if (util$enumos != Util.EnumOS.OSX)
        {
            ...
            try
            {
                ...
                inputstream = DefaultResourcePack.class.getResourceAsStream("/assets/minecraft/icons/icon16.png");
                inputstream1 = DefaultResourcePack.class.getResourceAsStream("/assets/minecraft/icons/icon16.png");
