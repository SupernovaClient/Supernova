    ...
    public static void checkDisplaySettings()
    {
        ...
        if (i > 0)
        {
            ...
            if (!Minecraft.isRunningOnMac && getDefaultResourcePack() != null)
            {
                ...
                try
                {
                    inputstream = getDefaultResourcePack().getInputStreamAssets(new ResourceLocation("icons/icon16.png"));
                    inputstream1 = getDefaultResourcePack().getInputStreamAssets(new ResourceLocation("icons/icon32.png"));
